...
async function resolveGraphiQLOptions(options: GraphiQLData | Function, ...args: any[]): Promise<GraphiQLData> {
...
export async function resolveGraphiQLString(query: any = {}, options: GraphiQLData | Function, ...args: any[]): Promise<string> {
